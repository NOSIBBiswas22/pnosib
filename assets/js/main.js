...
// team members 
    var tswiper = new Swiper(".teamSwiper", {
      slidesPerView: 3,
      spaceBetween: 30,
      grabCursor: true,
      slidesPerGroup: 3,
...
// // Select the elements to hover over
// const hoverElement1 = document.getElementById('hoverElement1');
// const hoverElement2 = document.getElementById('hoverElement2');

// // Combine the two elements to hover over
// const hoverElements = [hoverElement1, hoverElement2];

// // Create a variable to track the mouse hover state
// let isMouseOver = false;

// // Add a mouseover event listener to each of the elements to hover over
// hoverElements.forEach(element => {
//   element.addEventListener('mouseover', function() {
//     isMouseOver = true;
//   });

//   // Add a mouseout event listener to each of the elements to hover over
//   element.addEventListener('mouseout', function() {
//     isMouseOver = false;
//   });
// });

// // Create a function to click the button if the mouse is not hovering over the elements
// function clickButton() {
//       if (!isMouseOver) {
//     next_btn.click();
//   }
// }
// // Set the interval to 8 seconds and call the clickButton function
// setInterval(clickButton, 9000);

function autoClick(button, hoverpoint, delayTime) {
    const btn = document.getElementById(button),
          hoverElement = document.getElementById(hoverpoint),
          delay = delayTime;
    ...
    // Set the interval to 9 seconds and call the clickButton function
    setInterval(clickButton, 9000);
  }
  
  autoClick("next_btn1", "hoverElement1", 0);
  autoClick("next_btn2", "hoverElement2", 2000);
